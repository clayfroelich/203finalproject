...
final class WorldModel
{
   ...
   private static final int ZOMBIE_NUM_PROPERTIES = 6;
   ...
   public WorldModel(int numRows, int numCols, Background defaultBackground)
   {
      ...
      this.occupancy = new EntityType[numRows][numCols];
                                    ...
                                    ImageStore imageStore)
   {
      if (properties.length == MINER_NUM_PROPERTIES)
      {
         ...
         EntityType entity = new MinerNotFull(properties[MINER_ID],
                                       ...
                                       ImageStore imageStore)
   {
      if (properties.length == OBSTACLE_NUM_PROPERTIES)
      {
         ...
         EntityType entity = new Obstacle(properties[OBSTACLE_ID],
                                  ...
                                  ImageStore imageStore)
   {
      if (properties.length == ORE_NUM_PROPERTIES)
      {
         ...
         EntityType entity = new Ore(properties[ORE_ID],
                                    ...
                                    ImageStore imageStore)
   {
      if (properties.length == SMITH_NUM_PROPERTIES)
      {
         ...
         EntityType entity = new Blacksmith(properties[SMITH_ID],
                                   ...
                                   ImageStore imageStore)
   {
      if (properties.length == VEIN_NUM_PROPERTIES)
      {
         ...
         EntityType entity = new Vein(properties[VEIN_ID],
                 pt,
   ...
   private void tryAddEntity(EntityType entity)
   {
   ...
   public Optional<EntityType> findNearest(Point pos,
                                              Class<? extends EntityType> kind)
   {
      List<EntityType> ofType = new LinkedList<>();
   ...
   public void moveEntity(EntityType entity, Point pos)
   {
   ...
   private void removeEntityAt(Point pos)
   {
      if (withinBounds(pos)
              && this.getOccupancyCell(pos) != null)
      {
         EntityType entity = this.getOccupancyCell(pos);
   ...
   public Optional<EntityType> getOccupant(Point pos)
   {
      if (isOccupied(pos))
      {
   ...
   public EntityType getOccupancyCell(Point pos)
   {
   ...
   private static Optional<EntityType> nearestEntity(List<EntityType> entities,
                                                Point pos)
   {
      if (entities.isEmpty())
      {
      ...
      {
         EntityType nearest = entities.get(0);
         int nearestDistance = nearest.position().distanceSquared(pos);

         for (EntityType other : entities)
         {
