...
final class EventScheduler
{
   ...
   public Map<EntityType, List<Event>> pendingEvents;
   ...
   public void scheduleEvent(EntityType entity, ActionType action, long afterPeriod)
   {
   ...
   public void unscheduleAllEvents(EntityType entity)
   {
